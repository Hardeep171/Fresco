...
/**
 * Async thunk to fetch all services for admin (both active and inactive).
 */
...
/**
 * Async thunk to create a new service (Admin operation).
 */
...
/**
 * Async thunk to update an existing service (Admin operation).
 */
...
/**
 * Async thunk to enable a service (Admin operation).
 */
...
/**
 * Async thunk to disable a service (soft-delete, Admin operation).
 */
